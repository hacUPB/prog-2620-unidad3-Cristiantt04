...
for i in range(1, numero_tramos + 1 ):
    ...
    distancia = float(input("Ingresa la distanciad del tramo (en km): ")) #se pide ingresar la distancia del tramo
...
if combustible_actual >= reserva_legal:
    print(f"Haz llegado a {destino_final} sin utilizar el combustible de reserva, buen trabajo")
